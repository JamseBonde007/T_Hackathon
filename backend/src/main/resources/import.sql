...
Insert into post (id, name, content, image_url, likes, created_date, visibility, publisher_id) values (2,'R spring boot s december update & angular, java','','https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Spring_Framework_Logo_2018.svg/800px-Spring_Framework_Logo_2018.svg.png',56123,'2022-11-08',true,1);
...
Insert into job (id, name, description, job_type, company_contact_person_id) values (3, 'Senior Java - Spring boot developer', 'hibernate, spring boot, ...', 'plný pracovný úväzok', 5);
...
Insert into job (id, name, description, job_type, company_contact_person_id) values (8, 'Junior Angular developer', 'angular, ide, postman', 'brigáda', 5);